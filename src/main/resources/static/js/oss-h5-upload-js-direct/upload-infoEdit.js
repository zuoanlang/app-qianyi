...
var infoUploader = new plupload.Uploader({
    ...
    browse_button : 'selectfiles-infoEdit',
    ...
    init: {
        PostInit: function() {
            document.getElementById('ossfile-infoEdit').innerHTML = '';
            document.getElementById('postfiles-infoEdit').onclick = function() {
        ...
        FilesAdded: function(up, files) {
            ...
            if(!multi_selection_fm){
                ...
                plupload.each(files, function(file) {
                    document.getElementById('ossfile-infoEdit').innerHTML = '<div id="' + file.id + '">' + file.name + ' (' + plupload.formatSize(file.size) + ')<b></b>'
        ...
        FileUploaded: function(up, file, info) {
            if (info.status == 200)
            {
                ...
                $("#infoImgPathEdit").val(targeturl+"/"+get_uploaded_object_name(file.name))
