...
public class AliyunOSSUpload implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            UploadPartResult uploadPartResult = FileUploaderController.client.uploadPart(uploadPartRequest);
    ...
    protected static String claimUploadId(String bucketName, String key) {
        ...
        InitiateMultipartUploadResult result = FileUploaderController.client.initiateMultipartUpload(request);
    ...
    protected static void completeMultipartUpload(String uploadId) {
        ...
        // 完成分块上传
        FileUploaderController.client.completeMultipartUpload(completeMultipartUploadRequest);
    }
    ...
    protected static void listAllParts(String uploadId) {
        ...
        // 获取上传的所有分块信息
        PartListing partListing = FileUploaderController.client.listParts(listPartsRequest);
